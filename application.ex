defmodule Twitter.Application do
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      # supervisor(TwitterServer, [simulator_input])
    ...
    {:ok, _} = GenServer.start_link(TwitterServer, [simulator_input], name: :twitter_server)
    {:ok, _} = GenServer.start_link(TwitterSimulator, [simulator_input], name: :twitter_simulator)
